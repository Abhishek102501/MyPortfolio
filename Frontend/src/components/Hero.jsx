...
import { ArrowRight, Download, ChevronDown, Cpu, MapPin as MapPinIcon, Database, Github, Linkedin, Mail, Code2, Instagram } from 'lucide-react';
      ...
      <div className="relative z-10 max-w-3xl px-6 sm:px-8 md:px-12 w-full">
        ...
        >
          {[
            ...
            { href: 'https://www.instagram.com/abhishek.dubey09/', icon: Instagram, label: 'Instagram' },
